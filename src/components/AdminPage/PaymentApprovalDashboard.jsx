...
// import { Clock, CheckCircle, Users, Search, Check, X, Loader2, MoreHorizontal, XCircle, FileText } from 'lucide-react';

// // --- Helper Components ---

// // Reusable component for the dashboard summary cards
...
//     { id: 'pay_6', caseId: 'CASE-Z1Y2X3', doctorName: 'Dr. Marcus Thorne', doctorAvatar: 'https://placehold.co/40x40/38bdf8/ffffff?text=MT', caseDate: '2025-09-04', amount: 300, status: 'Rejected' },
...
//   const [loading, setLoading] = React.useState(null); // Tracks loading state for specific actions
...
//           <StatCard icon={<Clock className="h-7 w-7" />} title="Total Pending Amount" value={`₹${totalPending.toLocaleString('en-IN')}`} color="#f59e0b" />
//           <StatCard icon={<CheckCircle className="h-7 w-7" />} title="Processed This Month" value={`₹${processedThisMonth.toLocaleString('en-IN')}`} color="#10b981" />
//           <StatCard icon={<Users className="h-7 w-7" />} title="Doctors Awaiting Payment" value={doctorsAwaitingPayment} color="#3b82f6" />
//         </div>
