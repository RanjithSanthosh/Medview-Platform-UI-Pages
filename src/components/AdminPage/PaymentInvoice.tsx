...
// const PaymentInvoice = ({ doctorName, payments, onClose }) => {
//   // Ensure we only show processed payments on the invoice
...
//       pdf.save(`invoice-${doctorName.replace(/\s+/g, '-')}-September-2025.pdf`);
//     });
//   };
...
//         }
//       `}</style>
//       <div id="invoice-container" className="bg-gray-50 max-w-4xl w-full mx-auto rounded-xl shadow-2xl">
...
//             <div id="invoice-to-print" className="bg-white p-8 md:p-12 border border-gray-200 rounded-lg">
//                 <header className="flex justify-between items-start pb-6 border-b">
//                     <div>
//                         <h1 className="text-3xl font-bold text-gray-900">INVOICE</h1>
//                         <p className="text-gray-500 mt-1">Invoice #INV-2025-09-001</p>
//                     </div>
//                     <div className="text-right">
//                         <p className="text-xl font-semibold text-gray-800">[Image of Your Company Logo]</p>
//                         <p className="text-sm text-gray-500">123 Health St, MedCity, IN 46201</p>
//                     </div>
//                 </header>
...
//                         <p><span className="font-semibold text-gray-600">Date Issued:</span> September 09, 2025</p>
//                         <p><span className="font-semibold text-gray-600">Payment Due:</span> October 09, 2025</p>
//                     </div>
//                 </section>
                
//                 <section>
//                     <h3 className="font-semibold text-gray-500 text-sm uppercase tracking-wide mb-3">Invoice for services rendered in September 2025</h3>
...
//                 </div>
//                 <div className="text-right">
//                     <p className="text-xl font-semibold text-gray-800">[Your Company Name]</p>
//                     <p className="text-sm text-gray-500">123 Health St, MedCity, IN 46201</p>
//                 </div>
//             </header>
