...
// //                       setSidebarOpen(false); // Restore closing sidebar on item click
// //                     }}
// //                     className={[
...
//       <div
//         className={[
//           "fixed inset-y-0 left-0 z-40 bg-medical-sidebar transform transition-all duration-300 ease-in-out group overflow-y-auto",
//           sidebarOpen ? "w-64 translate-x-0" : "w-16 -translate-x-full",
//           "lg:translate-x-0 lg:fixed lg:w-16 lg:hover:w-64",
//         ].join(" ")}
//       >
