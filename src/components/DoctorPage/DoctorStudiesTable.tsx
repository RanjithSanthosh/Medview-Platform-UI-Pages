...
//   const TOTAL_TABLE_COLUMNS = 10; // Updated to match actual column count
...
//               <tr>
//                 <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-r border-gray-200">Order ID</th>
//                 <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-r border-gray-200">Patient Name</th>
//                 <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-r border-gray-200">Gender</th>
//                 <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-r border-gray-200">Study</th>
//                 <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-r border-gray-200">Modality</th>
//                 <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-r border-gray-200">Assigned To</th>
...
//                 // Apply red background highlighting for URGENT priority rows
//                 const urgentRowClass = study.priority === "URGENT" ? "bg-red-50" : "";

//                 return (
//                   <React.Fragment key={study.orderId}>
//                     <tr className={`hover:bg-gray-50 ${urgentRowClass}`}>
//                       <td className={`px-4 py-4 whitespace-nowrap text-sm text-blue-600 font-medium border-r border-gray-200 ${urgentRowClass}`}>{study.orderId}</td>
//                       <td className={`px-4 py-4 whitespace-nowrap text-sm text-gray-700 border-r border-gray-200 ${urgentRowClass}`}>{study.patientName}</td>
//                       <td className={`px-4 py-4 whitespace-nowrap text-sm text-gray-700 border-r border-gray-200 ${urgentRowClass}`}>{study.gender}</td>
//                       <td className={`px-4 py-4 whitespace-nowrap text-sm text-blue-600 border-r border-gray-200 ${urgentRowClass}`}>{study.study}</td>
//                       <td className={`px-4 py-4 whitespace-nowrap text-sm text-gray-700 border-r border-gray-200 ${urgentRowClass}`}>{study.modality}</td>

//                       <td className={`px-4 py-4 whitespace-nowrap text-sm text-gray-700 border-r border-gray-200 ${urgentRowClass}`}>
//                         {doctorNames[0]}
//                       </td>

//                       <td className={`px-4 py-4 whitespace-nowrap border-r border-gray-200 ${urgentRowClass}`}>
...
//                       {/* Icons column (no red background to keep it clean like in original) */}
...
//                           <button className="px-2 flex items-center justify-center text-gray-600 hover:bg-gray-100 p-1 focus:outline-none rounded" title="Email"><FaEnvelope className="w-4 h-4" /></button>
//                           <button className="px-2 flex items-center justify-center text-gray-600 hover:bg-gray-100 p-1 focus:outline-none rounded" title="Lock"><FiLink className="w-4 h-4" /></button>
//                           <button
//                             onClick={() => {
...
//                             }}
//                             className="px-2 flex items-center justify-center text-gray-600 hover:bg-gray-100 p-1 focus:outline-none rounded"
//                             title="Edit"
//                           >
//                             <FiFileText className="w-4 h-4" />
//                           </button>
//                           <button className="px-2 flex items-center justify-center text-gray-600 hover:bg-gray-200 p-1 focus:outline-none rounded" title="View Details"><BsInfoCircle className="w-4 h-4" /></button>
//                         </div>
//                       </td>

//                       {/* Action column (no red background to keep it clean like in original) */}
//                       <td className="px-4 py-2 text-sm">
//                         <Button
//                           variant="ghost"
//                           size="sm"
//                           className="text-white bg-blue-600 hover:bg-blue-700 flex items-center gap-1"
...
const DoctorStudiesTable: React.FC<DoctorStudiesTableProps> = ({
  ...
  // Modal state for patient report
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200 table-fixed">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {filteredData.map((study) => {
                const urgentCellClass =
                  study.priority === "URGENT" ? "bg-red-50" : "";

                return (
                  <tr key={study.orderId} className="hover:bg-gray-50">
                    <td
                      className={`px-4 py-4 whitespace-nowrap text-sm text-blue-600 font-medium border-r border-gray-200 ${urgentCellClass}`}
                    >
                      {study.orderId}
                    </td>
                    <td
                      className={`px-4 py-4 whitespace-nowrap text-sm text-gray-700 border-r border-gray-200 ${urgentCellClass}`}
                    >
                      {study.patientName}
                    </td>
                    <td
                    ...
                    <td
                      className={`px-4 py-4 whitespace-nowrap text-sm text-blue-600 border-r border-gray-200 ${urgentCellClass}`}
                    >
                      {study.study}
                    </td>
                    <td
                    ...
                    <td
                      className={`px-4 py-4 whitespace-nowrap border-r border-gray-200 ${urgentCellClass}`}
                    >
                      <span
                    ...
                    <td className="px-4 py-4 whitespace-nowrap text-sm border-r border-gray-200">
                      <div className="flex justify-center bg-white rounded overflow-hidden space-x-1">
                        ...
                        <button
                          className="px-2 flex items-center justify-center text-gray-600 hover:bg-gray-200 p-1 focus:outline-none rounded"
                          title="View Details"
                        >
                          <BsInfoCircle className="w-4 h-4" />
                        </button>
