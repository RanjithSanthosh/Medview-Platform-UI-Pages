...
// import { FileText, User, ChevronDown, DollarSign, Calendar } from 'lucide-react';

// // --- CONSTANTS ---
// const PAYMENT_PER_CASE = 300;

// // --- AUTHENTICATION SIMULATION ---
// // In a real application, this would come from a context or authentication hook.
// // We are simulating that "Dr Gopinath" has logged in.
// const MOCK_LOGGED_IN_DOCTOR = {
//   name: "Dr Gopinath",
//   id: "DOC-GOP-01"
// };

// // --- MOCK DATA (Source of truth for all cases) ---
...
// // This component remains largely unchanged as its function is still needed.
...
// // --- PARENT COMPONENT: The Main Page for the Logged-In Doctor ---
// const DoctorPaymentHistoryPage = () => {
    
//     // The component now assumes it knows the logged-in doctor.
//     const loggedInDoctor = MOCK_LOGGED_IN_DOCTOR;

//     // The core data transformation logic is now simplified.
//     // It filters for the logged-in doctor *first*, then aggregates the data.
//     const paymentData = useMemo(() => {
//         const data = {};
        
//         // 1. Filter cases for the logged-in doctor only
//         const doctorsCases = completedStudiesData.filter(
//             study => study.assignedTo === loggedInDoctor.name
//         );
        
//         // 2. Aggregate the filtered cases by month
//         doctorsCases.forEach(study => {
...
//             if (!data[monthKey]) {
//                 data[monthKey] = { studies: [], caseCount: 0, totalPayout: 0 };
//             }

//             data[monthKey].studies.push(study);
//             data[monthKey].caseCount += 1;
...
//                     <h1 className="text-3xl font-bold text-gray-800">Your Payment History</h1>
//                     <p className="text-gray-500 mt-1">Hello, <span className="font-semibold">{loggedInDoctor.name}</span>. Here is your payout history based on completed cases.</p>
//                 </header>
...
//                                 <p className="text-4xl font-bold text-green-700 mt-2">{totalPayout.toLocaleString('en-IN', { style: 'currency', currency: 'INR' })}</p>
//                             </div>
//                             <div className="bg-blue-50 border border-blue-200 p-5 rounded-xl">
//                                 <h3 className="font-semibold text-blue-800">Total Cases Completed</h3>
//                                 <p className="text-4xl font-bold text-blue-700 mt-2">{totalCases}</p>
//                             </div>
//                         </div>
                        
//                         {/* Monthly Accordions */}
//                         <h3 className="text-xl font-semibold text-gray-700 mb-4">Payouts by Month</h3>
//                         <div>
...
//                                     <h3 className="mt-2 text-lg font-medium text-gray-900">No Payment History Found</h3>
//                                     <p className="mt-1 text-sm text-gray-500">We could not find any completed cases assigned to you.</p>
//                                 </div>
//                             )}
//                         </div>
//                     </div>
